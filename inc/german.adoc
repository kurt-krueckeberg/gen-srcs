...
https://www.dagv.org/?Die_DAGV___Mitgliedsvereine[German Genalogical Associations belonging to Deutsche Arbetisgemeinschaft genealogisher Verbände e.V.(DAGV)]
...
https://gov.genealogy.net/search/index[Historic Gazetteer of CompGen]
...
These books focus on one town/village, and are a compilation of all family data for people who
lived in that village, generally using church records as a source. 

Pros:
these are printed and easy to read and show all family connections. 

Cons:
Since they’re transcriptions of original records, errors may exist.
But using these can help you more easily locate
...
* https://ofb.genealogy.net/[CompGen Collection of Online Ortsfamilienbücher]

  From the https://www.compgen.de/portfolio-item/db-ortsfamilienbuecher/[The CompGen description]:
...
* Databases: Includes searchable databases that include gravestones, war casualty lists,
 directories, individual members’ trees, etc. http://www.compgen.de/recherchieren/#datenbanken

- https://des.genealogy.net/search/allProjects[Search of Projects of Verein für Computergenealogie]

- https://gedbas.genealogy.net/?lang=en[GEDBAS Surname Database Search]
  ...
  The GEDBAS project was launched by the Verein für Computergenealogie eV . It is intended to help researchers in Germany to
  find contacts with other interested researchers and to exchange results. Unlike FOKO, concrete data is also published here.
  Inquiries by email or post no longer have to be made in every case, since those who are interested in the names can already
  tell when searching in the database whether the research results are of interest to them or not.

* GenWiki: Includes articles on many German genealogy-related topics
http://wiki- de.genealogy.net/Hauptseite

* https://nvk.genealogy.net/map[German Surname Distribution Map]
...
Liste von https://www.familienkunde-oldenburg.de/recherche/genealogische-vereine-im-norden-deutschlands/[Genealogische Vereine im Norden Deutschlands].
